              ...
              <tbody>
                {data.locations.map((s) => (
                  <tr key={s.locationId} className="border-b border-gray-50 last:border-0">
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div className="min-w-0">
                          {s.userId ? (
                            <Link
                              href={`/admin/sub-accounts/${s.userId}`}
                    ...
                    <td className="px-5 py-3.5 text-right">
                      {/* Profile exists only once the client has a portal identity. */}
                      {s.userId ? (
                        <Link
                          href={`/admin/sub-accounts/${s.userId}`}
                          className="inline-flex items-center text-[12px] font-semibold text-blue-600 hover:text-blue-700"
                        >
                          View profile
                        </Link>
                      ) : (
